  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>군산 경장동 중해마루힐 - 호수배치도</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.cssdesign.kr/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="군산 경장동 중해마루힐 - 호수배치도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.cssdesign.kr/ComplexGuide/detailintro"
        />
        ...
        <script type="application/ld+json">
          {`
			...
			"url": "https://www.cssdesign.kr/ComplexGuide/detailintro"
					}
					`}
        </script>
      </Helmet>
