  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>군산 경장동 중해마루힐 - 단지배치도</title>
        <meta
          name="description"
          content="단지 배치도 페이지는 군산 경장동 중해마루힐의 전체 단지 구성도를 제공합니다. 아파트 단지 내 세대 배치, 공용 시설, 주차 공간 등을 시각적으로 보여주어 입주자들이 공간 배치에 대해 명확하게 이해할 수 있도록 돕습니다. 이 배치도를 통해 단지 내 생활을 더 쉽게 계획할 수 있습니다."
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://www.cssdesign.kr/ComplexGuide/intro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="군산 경장동 중해마루힐 - 단지배치도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.cssdesign.kr/ComplexGuide/intro"
        />
        ...
        <script type="application/ld+json">
          {`
			...
			"description": "단지 배치도 페이지는 군산 경장동 중해마루힐의 전체 단지 구성도를 제공합니다. 아파트 단지 내 세대 배치, 공용 시설, 주차 공간 등을 시각적으로 보여주어 입주자들이 공간 배치에 대해 명확하게 이해할 수 있도록 돕습니다. 이 배치도를 통해 단지 내 생활을 더 쉽게 계획할 수 있습니다.",
      ...
      <p className={styles.screenReaderOnly}>
        단지 배치도 페이지는 군산 경장동 중해마루힐의 전체 단지 구성도를
