  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>둔산 해링턴 플레이스 - 계약서류안내</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://www.cssdesign.kr/BusinessGuide/documents" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="둔산 해링턴 플레이스 - 계약서류안내" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.cssdesign.kr/BusinessGuide/documents"
        />
        ...
        <script type="application/ld+json">
          {`
						...
						"url": "https://www.cssdesign.kr/BusinessGuide/documents"
								}
								`}
        </script>
      </Helmet>
